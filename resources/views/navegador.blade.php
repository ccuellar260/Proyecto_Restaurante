...
<body class="bg-blue-200">
    ...
    <div class="bg-indigo-900 flex p-2 shadow-sm ">
        <div class="ml-4 w-14 h-14 rounded-full bg-black border-2 border-black">
            <img src="{{ asset('img/KureGrill ico.png') }}"; class="rounded-full w-auto" />
        </div>
    ...
    <div class="flex screen-full">
        <div class="p-2 border-r w-60 border-gray-200 bg-indigo-900 pb-10">
            ...
            <ul>
                <li class="mb-4 flex hover:bg-slate-500 rounded">
                    ...
                    <span class="self-center text-white"><a href="{{ Route('Dashboard') }}"> Dashboard</a></span>
                </li>
        ...
        <div class="m-8 pt-6 lg:mt-0 lg:px-2 lg:w-4/5 ">
            @yield('Contenido')
        </div>
    </div>
