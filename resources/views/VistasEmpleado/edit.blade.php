            ...
            <form action="{{ Route('Empleado.update', $fila->ci) }}" method="POST">
                ...
                <div class="grid gap-2 grid-cols-2">
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" name="nombre_usuario" value="{{ $fila->nombre_usuario }}" id="usuario"
                            placeholder=""
                    ...
                    <div class="mb-5">
                        ...
                        <input type="password" name="contra_new" value="" id="contrasena" placeholder="password"
                            class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                        @if (session('contra_vacia_contra_new'))
                    ...
                    <div class="mb-5">
                        ...
                        <input type="password" name="contra_new2" value="" id="contrasena" placeholder="password"
                            class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                        @if (session('contra_vacia_contra_new2'))
                            <!--Existe el atributo status?-->
                            <!-- mostarr lo que esta en status-->
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" name="nombre_completo" value='{{ $fila->nombre_completo }}'
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" name="rol" value="{{ $fila->descripcion }}" id="rol"
                            placeholder=""
                            class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"
                            readonly />
                    </div>
                    ...
                    <div class="mb-5">
                        ...
                        <input type="password" name="contra_antigua" value="" id="contrasena"
                            placeholder="password"
                            class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                        @if (session('Contra_incorrecta'))
                            <!--Existe el atributo status?-->
                            <!-- mostarr lo que esta en status-->
