...
<div class="text-center "
    ...
    <div class=" max-w-max bg-red-700 p-2 flex space-x-2 rounded-3xl ">
        <button  @click="modelOpen =!modelOpen"
    class="place-self-center text-white  font-semibold"
        href="">
        CAMBIAR CONTRASENA
    </button>
    </div>
            ...
            <form action="{{Route('Login.resertContrasena')}}" method="GET">
                ...
                <div class="mb-4 mt-6">
                    <label class="block mb-2 text-sm font-bold text-gray-700" for="emailRestore">
                        Introdusca su Nueva Contrasena
                    </label>
                    <input
                ...
                <div class="mb-4 mt-6">
                    <label class="block mb-2 text-sm font-bold text-gray-700" for="emailRestore">
                        Vuela a introducir su Nueva Contrasena
                    </label>
                    <input
                        class="w-full px-3 py-2 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                        id="emailRestore"
